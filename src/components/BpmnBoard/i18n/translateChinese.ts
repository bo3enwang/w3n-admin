export default {
  ...
  "Divide into two Lanes": "分离为二泳道",
  "Divide into three Lanes": "分离为三泳道",
  "Add Lane below": "在下面添加泳道",
  "Append compensation activity": "添加补偿活动",
  "Change type": "更改类型",
  "Connect using Association": "使用Association连接",
  ...
  "Signal Boundary Event (non-interrupting)":
    "Angeheftetes Signal-Zwischenereignis (nicht unterbrechend)",
  ...
  "flow elements must be children of pools/participants":
    "Fluss-Elemente müssen Kinder von Pools/Teilnehmern sein",
